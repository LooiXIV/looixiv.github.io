...
Instead of gifts we suggest making a donation to one (or more) of these scholarships or charities.
...
This scholarship gives preference to U.S. Military veterans planning to study computer science, information systems, science and/or math.

[Clare Seow Looi Scholarship fund](https://makeagift.stanford.edu)

This is a scholarship fund for undergraduates that emphasizes Science and Engineering.

To make a donation to the Clare Seow Looi Scholarship:

1. Click the above link and from the drop down menu select "Centers, Institutes, and More."

2. From the next drop down menu select "Other Designation."

3. Add "The Clare Seow Looi Scholarship Fund" as the special instructions.

4. Select "One-Time Gift" and fill in the amount.


# Charities:
You can also make donations to [Catholic Charities USA](https://www.catholiccharitiesusa.org/) in memory of Matthew and Dorothy Bowe, and Robert J. Quinn.

Or a charity of your choice in honor of someone else, below are two origanizations that Julie and Alex have contributed to in the past. 
